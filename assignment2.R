...
rm(list = ls())
mypath<-'E:/USERS/econ_big_data/data/assignment_idaccuracy/Aminer/'
setwd(mypath)
file.exists(mypath)
...
write_csv(data,paste0("E:/USERS/econ_big_data/assignment/","assign2_merged_data.csv"))
...
setwd('E:/USERS/econ_big_data/function')
source("read_csv.R")
